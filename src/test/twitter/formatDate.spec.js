...
describe('Twitter utilites', () => {
  describe('formatTwitterDate', () => {
    ...
    it('calculates weeks to months', () => {
      ...
      expect(source.formatTwitterDate(`Wed May 04 10:00:00 ${timeZoneOffset} 2016`, feb1)).to.be('10 months ago');
      expect(source.formatTwitterDate(`Wed Feb 03 10:00:00 ${timeZoneOffset} 2016`, feb1)).to.be('13 months ago');
    });
  });
});
